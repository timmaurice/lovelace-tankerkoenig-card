      ...
      <ha-card .header=${this._config.title} tabindex="0">
        <div class="card-content">
          ${i.map(([s,i])=>{const o=i.e5||i.e10||i.diesel||i.status;if(!o)return F`
              ...
              `;const n=!!i.status&&"on"===this.hass.states[i.status].state,r=this.hass.states[o],a=r.attributes,c=this.hass.devices[s],l=c?.name_by_user||c?.name||a.station_name||a.friendly_name,h=t=>t?t.toLowerCase().replace(/(?:^|\s|["'([{]|-)+\S/g,t=>t.toUpperCase()):"",d=a.house_number,p=[[h(a.street||""),d&&"none"!==d.toLowerCase()?d.trim():""].filter(Boolean).join(" "),[a.postcode||"",h(a.city||"")].filter(Boolean).join(" ")].filter(Boolean).join(", ");return F`
              <div class="station ${n?"open":"closed"}" tabindex="0">
                ...
                <div class="info">
                  ...
                  ${this._config.show_address?F`<div class="row-2"><span class="address">${p}</span></div>`:""}
                ...
                <div class="prices">
                  ${t.map(t=>{const s=i[t];if(!s)return"";const o=this.hass.states[s],n="unavailable"===o.state||isNaN(parseFloat(o.state));let r="-.--",a="-";const c=o.attributes.unit_of_measurement||"";if(!n){const t=o.state.split(".");r=`${t[0]}.${t[1].substring(0,2)}`,a=t[1].substring(2,3)}const l=this._config.show_price_changes&&!n&&this._priceChanges[s]||"";return F`<div
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function(t){return(e,s,i)=>((t,e,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,s),s))(e,s,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}("ha-card")],kt.prototype,"_card",void 0),t([ut()],kt.prototype,"_config",void 0),t([ut()],kt.prototype,"_priceChanges",void 0),kt=t([lt(xt)],kt),"undefined"!=typeof window&&(window.customCards=window.customCards||[],window.customCards.push({type:xt,name:"Tankerkönig Card",description:"A Lovelace card to display German fuel prices from Tankerkönig.",documentationURL:"https://github.com/timmaurice/lovelace-tankerkoenig-card"}));const Et=a`.card-config{display:flex;flex-direction:column;gap:12px}.group{border:1px solid var(--divider-color);border-radius:var(--ha-card-border-radius, 4px);margin-top:8px;padding:16px}.group-header{color:var(--primary-text-color);font-size:16px;font-weight:500;margin-bottom:12px}.row{align-items:center;display:flex;flex-direction:row;gap:16px}.row>*{flex:1 1 50%;min-width:0}ha-formfield{align-items:center;display:flex;justify-content:space-between;padding-bottom:8px}.station-row{align-items:center;display:flex;gap:8px;margin-bottom:8px}.station-row .logo{border-radius:4px;flex-shrink:0;height:32px;object-fit:contain;width:32px}.station-row .station-name{flex-grow:1;font-weight:500;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.add-icon{margin-right:8px}.tabs{border-bottom:1px solid var(--divider-color);display:flex}.tab-content{padding-top:16px}ha-tab{--paper-tabs-selection-bar-color: var(--primary-color);color:var(--secondary-text-color);cursor:pointer;padding:0 16px;position:relative}ha-tab.active{border-bottom:2px solid var(--primary-color);color:var(--primary-text-color);margin-bottom:-1px}.search-bar{padding:0 24px}ha-textfield{width:100%}.device-list{margin-top:16px;max-height:400px;overflow-y:auto}ha-dialog{--mdc-dialog-min-width: 400px;--mdc-dialog-max-width: 500px}ha-dialog ha-textfield{display:block;margin-bottom:16px}`,Ct=[{name:"title",selector:{text:{}}}],Pt=[{name:"stations",selector:{device:{multiple:!0,integration:"tankerkoenig"}}}];let Ot=class extends at{constructor(){super(...arguments),this._dialogParams={},this._customizeInputValue="",this._selectedTab=0}setConfig(t){this._config=t}_valueChanged(t){if(!this.hass||!this._config)return;const e=(t.detail.value.stations||[]).map(t=>this._config.stations.find(e=>("string"==typeof e?e:e.device)===t)||t),s={...this._config,...t.detail.value,stations:e};vt(this,"config-changed",{config:s})}_updateStation(t,e){if(!this._config)return;const s=[...this._config.stations];s[t]=e;const i={...this._config,stations:s};vt(this,"config-changed",{config:i})}_removeStation(t){if(!this._config)return;const e=[...this._config.stations];e.splice(t,1);const s={...this._config,stations:e};vt(this,"config-changed",{config:s})}render(){if(!this.hass||!this._config)return F``;let t=[{name:"show_address",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"show_price_changes",selector:{boolean:{}}},{name:"hide_unavailable_stations",selector:{boolean:{}}},{name:"fuel_types",selector:{select:{multiple:!0,mode:"list",options:[{value:"diesel",label:yt(this.hass,"component.tankerkoenig-card.editor.fuel_type_options.diesel")},{value:"e10",label:yt(this.hass,"component.tankerkoenig-card.editor.fuel_type_options.e10")},{value:"e5",label:yt(this.hass,"component.tankerkoenig-card.editor.fuel_type_options.e5")}]}}},{name:"sort_by",selector:{select:{mode:"dropdown",options:[{value:"none",label:yt(this.hass,"component.tankerkoenig-card.editor.sort_by_options.none")},{value:"diesel",label:yt(this.hass,"component.tankerkoenig-card.editor.fuel_type_options.diesel")},{value:"e10",label:yt(this.hass,"component.tankerkoenig-card.editor.fuel_type_options.e10")},{value:"e5",label:yt(this.hass,"component.tankerkoenig-card.editor.fuel_type_options.e5")}]}}},{name:"show_only_cheapest",selector:{boolean:{}}}];return this._config.sort_by&&"none"!==this._config.sort_by||(t=t.filter(t=>"show_only_cheapest"!==t.name)),F`
      <ha-card>
        <div class="card-content card-config">
          <div class="group">
            <div class="group-header">${yt(this.hass,"component.tankerkoenig-card.editor.groups.core")}</div>
            <ha-form
              .schema=${Ct}
              .hass=${this.hass}
              .data=${this._config}
              .computeLabel=${t=>yt(this.hass,`component.tankerkoenig-card.editor.${t.name}`)}
              @value-changed=${this._valueChanged}
            ></ha-form>
          </div>

          <div class="group">
            <div class="group-header">${yt(this.hass,"component.tankerkoenig-card.editor.stations")}</div>
            <!-- Tabs -->
            <div class="tabs">
              <ha-tab class=${0===this._selectedTab?"active":""} @click=${()=>this._selectedTab=0}
                >${yt(this.hass,"component.tankerkoenig-card.editor.tab_select")}</ha-tab
              >
              <ha-tab class=${1===this._selectedTab?"active":""} @click=${()=>this._selectedTab=1}
                >${yt(this.hass,"component.tankerkoenig-card.editor.tab_customize")}</ha-tab
              >
            </div>
          ...
          <div class="group">
            <div class="group-header">${yt(this.hass,"component.tankerkoenig-card.editor.groups.display")}</div>
            <ha-form
              .schema=${t}
              .hass=${this.hass}
              .data=${this._config}
    ...
    `}_renderStation(t,e){const s="string"==typeof t?t:t.device,i="object"==typeof t?t.logo:void 0,o=this.hass.devices[s],n=o?.name_by_user||o?.name||`Station ${e+1}`,r=wt(this._getBrandFromDevice(s));return F`
      <div class="station-row">
        <img
          ...
          @error=${t=>t.target.src=wt()}
        />
        <span class="station-name">${n}</span>
        <ha-icon-button
          .label=${yt(this.hass,"component.tankerkoenig-card.editor.customize")}
          @click=${()=>this._showCustomizeDialog(t,e)}
        >
          <ha-icon icon="mdi:pencil"></ha-icon>
        </ha-icon-button>
        <ha-icon-button
          .label=${yt(this.hass,"component.tankerkoenig-card.editor.remove")}
          @click=${()=>this._removeStation(e)}
        >
          <ha-icon icon="mdi:close"></ha-icon>
        </ha-icon-button>
      </div>
    `}_showCustomizeDialog(t,e){console.log("[Tankerkoenig Editor] Firing show-dialog for CustomizeDialog");const s="string"==typeof t?t:t.device;this._customizeInputValue="object"==typeof t&&t.logo||"",this._dialogParams={index:e,deviceId:s},this.shadowRoot?.querySelector("#customize-dialog")?.show()}_getBrandFromDevice(t){const e=Object.values(this.hass.states).find(e=>this.hass.entities[e.entity_id]?.device_id===t&&["e5","e10","diesel"].includes(e.attributes.fuel_type)),s=e?.attributes.brand;return"string"==typeof s&&"none"!==s.toLowerCase()?s:void 0}_renderCustomizeDialog(){return F`
      <ha-dialog
        id="customize-dialog"
        .heading=${yt(this.hass,"component.tankerkoenig-card.editor.customize")}
        @closed=${t=>{"primary"!==t.target.closingReason&&(this._customizeInputValue="")}}
      >
        <ha-textfield
          .label=${yt(this.hass,"component.tankerkoenig-card.editor.logo_url")}
          .placeholder=${yt(this.hass,"component.tankerkoenig-card.editor.logo_url_placeholder")}
        ...
        <mwc-button dialogAction="primary" slot="primaryAction" @click=${this._confirmCustomize}>
          ${yt(this.hass,"component.tankerkoenig-card.editor.save")}
        </mwc-button>
        <mwc-button dialogAction="cancel" slot="secondaryAction">
          ${yt(this.hass,"component.tankerkoenig-card.editor.cancel")}
        </mwc-button>
      </ha-dialog>
    `}_confirmCustomize(){const{index:t,deviceId:e}=this._dialogParams,s=this._customizeInputValue;void 0!==t&&void 0!==e&&(s?this._updateStation(t,{device:e,logo:s}):this._updateStation(t,e))}static{this.styles=a`
    ${r(Et)}
  `}};t([pt({attribute:!1})],Ot.prototype,"hass",void 0),t([ut()],Ot.prototype,"_config",void 0),t([ut()],Ot.prototype,"_dialogParams",void 0),t([ut()],Ot.prototype,"_customizeInputValue",void 0),t([ut()],Ot.prototype,"_selectedTab",void 0),Ot=t([lt("tankerkoenig-card-editor")],Ot);var Tt=Object.freeze({__proto__:null,get TankerkoenigCardEditor(){return Ot}});export{kt as TankerkoenigCard};
